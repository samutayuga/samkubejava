...
public class SettingLoader {
    ...
    private static final List<String> DEFAULT_CONFIG_LIST = Lists.newArrayList("minimart");

    private static final String DEFAULT_CONFIG_PATH = System.getenv("APP_ETC") + File.separator + "minimart";
